...
For the blackbox testing, the gradebot.exe test client, found [here]([https://github.com/jh125486/CSCE3550/releases]), is moved into the project folder and is executed using the "./gradebot.exe project-2 --run="py main.py"" command.
